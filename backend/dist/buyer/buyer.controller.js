...
let BuyerController = class BuyerController {
    constructor(productService, buyerService) {
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], BuyerController.prototype, "getCategoriesForBuyer", null);
__decorate([
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], BuyerController.prototype, "delete", null);
